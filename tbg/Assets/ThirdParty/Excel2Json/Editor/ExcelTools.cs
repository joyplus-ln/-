...
public class ExcelTools : EditorWindow
{
    ...
    private void DrawOptions()
    {
        ...
        //GUILayout.BeginHorizontal();
        //character = (CharacterItem)EditorGUILayout.ObjectField("character:", character, typeof(CharacterItem));
        //GUILayout.EndHorizontal();
    ...
    private void DrawExport()
    {
        ...
        else
        {
            ...
            if (GUILayout.Button("copy character"))
            {
                CopyCharacter();
            }
            if (GUILayout.Button("copy equipment"))
            {
                CopyEquipment();
            }

            if (GUILayout.Button("copy skill"))
            {
                CopySkill();
            }
        }
    ...
    private void CopyCharacter()
    {
        foreach (string assetsPath in excelList)
        {
            ...
            //判断输出类型
            excel.ConvertToCharacter(excelPath, encoding, character);
    ...
    private void CopyEquipment()
    {
        foreach (string assetsPath in excelList)
        {
            ...
            //判断输出类型
            excel.ConvertToEquipment(excelPath, encoding, equip);
