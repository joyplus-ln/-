...
{
    //public static void SortLevel(this List<IPlayerHasCharacters> item)
    //{
    //    item.Sort((a, b) =>
    //    {
    ...
    //        if (a == null && b != null) return -1;
    //        var aValue = PlayerFormation.ContainsDataWithItemId(a.GUID) || a.EquippedByItem != null ? 0 : 1000000;
    //        var bValue = PlayerFormation.ContainsDataWithItemId(b.GUID) || b.EquippedByItem != null ? 0 : 1000000;
