...
public static class PlayerItemSort
{
    public static void SortLevel(this List<PlayerItem> item)
    {
        item.Sort((a, b) =>
        {
            ...
            if (a == null && b != null) return -1;
            var aValue = PlayerFormation.ContainsDataWithItemId(a.SqLiteIndex) || a.EquippedByItem != null ? 0 : 1000000;
            var bValue = PlayerFormation.ContainsDataWithItemId(b.SqLiteIndex) || b.EquippedByItem != null ? 0 : 1000000;
