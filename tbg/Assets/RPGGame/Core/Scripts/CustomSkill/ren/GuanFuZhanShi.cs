...
public class GuanFuZhanShi
{
    ...
    public class GuanFuZhanShi001 : CustomSkill
    {
        ...
        public override IEnumerator DoSkillLogic()
        {
            ...
            var attackDamage0 = new SkillAttackDamage(200, 0.3f, 0);
            ...
            yield return MoveToTarget();
            var attackDamage1 = new SkillAttackDamage(200, 0.3f, 0);
            ...
            yield return MoveToSelfPos();
            yield return MoveToTarget();
            var attackDamage2 = new SkillAttackDamage(200, 0.3f, 0);
