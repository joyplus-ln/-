...
[System.Serializable]
public class UIDataItemEvent : UnityEvent<RpguiDataItem> { }

public abstract class RpguiDataItem : RPGUIBase
{
    // Decoration
    ...
    [HideInInspector]
    public RpguiList list;
}

public abstract class RpguiDataItem<T> : RpguiDataItem where T : class
{
    // Data
    public T data;
    protected T dirtyData;
    public bool ShowOnceCustomSkill = false;
