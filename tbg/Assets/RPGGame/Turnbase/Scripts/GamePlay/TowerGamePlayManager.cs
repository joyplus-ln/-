...
public class TowerGamePlayManager : BaseGamePlayManager
{
    public static TowerGamePlayManager Singleton { get; private set; }
    public Camera inputCamera;
    [Header("Formation/Spawning")]
    public TowerGamePlayFormation playerFormation;
