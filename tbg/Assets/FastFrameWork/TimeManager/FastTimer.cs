...
public class FastTimer
{
    ...
    {
        if (FastTimer._manager != null)
        {
            FastTimer._manager.CancelAllTimers();
        }
    ...
    public static void PauseAllRegisteredTimers()
    {
        if (FastTimer._manager != null)
        {
            FastTimer._manager.PauseAllTimers();
        }
    ...
    public static void ResumeAllRegisteredTimers()
    {
        if (FastTimer._manager != null)
        {
            FastTimer._manager.ResumeAllTimers();
        }
    ...
    private static FastTimerManager _manager;
    ...
    private FastTimer(float duration, Action onComplete, Action<float> onUpdate,
